...
namespace btService.Controllers
{
    public class InterfaceController : ApiController
    {
        ...
        [BasicAuthentication]
        public HttpResponseMessage Interface_Usuario_Ativacao(string Aplicativo, string CodPuxada, string TelefoneCadastro, string Servico, string Cargo, string Telefone, string Nome, string Codigo, string Ativo = "S")
        {
            ...
            try
            {
                ...
                sMensagem = "/ativar." + Aplicativo + "." + Servico + "." + CodPuxada + "." + Cargo + "." + Telefone + "." + Nome + "." + Codigo + "." + Ativo;
